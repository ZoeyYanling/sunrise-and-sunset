$(document).ready(function () {
    //To accept the selected city search
    ...
    function weatherFunction(searchTerm) {
      ...
      $.ajax({
        ...
        $.ajax({
            ...
            var rise= $("<p>").addClass("card-text").text("Sunrise: " + data.results.sunrise + " UTC");
            var sset= $("<p>").addClass("card-text").text("Sunset: " + data.results.sunset + " UTC");
            cardBody.append(rise, sset);
        });
        $.ajax({
          type: "GET",
